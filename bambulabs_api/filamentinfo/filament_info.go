...
func (f Filament) GetSettings() AMSFilamentSettings {
	settings := map[Filament]AMSFilamentSettings{
		...
		FilamentBambuPLABasic:        {"GFA00", 190, 230, "PLA"},
		FilamentBambuPLAMatte:        {"GFA01", 190, 230, "PLA"},
